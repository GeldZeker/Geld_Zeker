...
namespace GameStudio.GeldZeker.Player.Introductions
{
    ...
    [CreateAssetMenu(menuName = "Player/Introductions/Introduction")]
    public class Introduction : ScriptableObject
    {
        ...
        public void Start()
        {
            ...
            {
                OnIntroStart();
                MainCanvasManager.Instance.StartMonologue(monologue, OnIntroFinished);
            }
        }
        ...
        private void SaveToFile()
        {
            ...
            GameFileSystem.SaveToFile(path, finished);
        }
